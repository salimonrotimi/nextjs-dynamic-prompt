...
export const GET = async(request, { params }) => {
    ...
    try {
        ...
        const findResult = await PromptSchemaModel.findById(id)
        ...
        // sanitize retrieved data. "findResult" is a single data so "array.forEach()" is not needed with it
        const result = sanitizeHTML(findResult);
...
export const PUT = async(request, { params }) => {
    ...
    try {
        ...
        const result = await PromptSchemaModel.findOneAndUpdate({ _id: id }, { prompt, tag });
