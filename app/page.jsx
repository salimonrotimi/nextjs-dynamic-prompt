...
function Home() {
  ...
  const handleHomePostClick = async(postItem) => {
    router.push(`/public-profile?id=${postItem._id}&quotient=${postItem.creator?.username}&factor=${postItem.creator?.image}`);
  }
  ...
  return (
    <section className='mt-[100px] text-center w-full flex flex-col justify-center'>
      ...
      <p className="w-[90%] max-w-[800px] mt-10 mx-auto text-center text-gray-600 dark:text-white font-bold">
          A modern prompting tool for making and sharing creative prompts. <br/> Sign in to get started.
      </p>
