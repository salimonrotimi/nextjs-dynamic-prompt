...
function Feed(props) {
  ...
  const handleSearchFilters = useMemo(() => {
    ...
    return retrievedPosts.filter(item => {
      ...
      return false; // i.e. returns whole retrievedPosts if the search "term" match none of the above "if" block
    });
